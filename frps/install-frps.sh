...
export PATH
#===============================================================================================
#   所需系统:  CentOS Debian or Ubuntu (32bit/64bit)
#   描述:  一个在Linux上自动编译和安装frps的工具
#   作者: Clang
#   修复: 封尘半烟
#===============================================================================================
program_name="frps"
...
program_version_link="https://raw.githubusercontent.com/jsgzsjskj/Frps-install/master/frps/version.sh"
str_install_shell=https://raw.githubusercontent.com/jsgzsjskj/Frps-install/master/frps/install-frps.sh
shell_update(){
    fun_clangcn "clear"
...
fun_clangcn(){
    ...
    echo ""
    echo "+---------------------------------------------------------+"
    echo "|         frps for Linux Server, 修复 by 封尘半烟          |"
    echo "+---------------------------------------------------------+"
    echo "|     	一个在Linux上自动编译和安装frps的工具  	    |"
    echo "+---------------------------------------------------------+"
    echo "|           Frp一键安装脚本 修复 by 封尘半烟                |"
    echo "+---------------------------------------------------------+"
    echo ""
}
fun_set_text_color(){
